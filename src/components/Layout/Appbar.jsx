      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="fixed" open={open}>
          <TopToolbar >
            ...
            <Box sx={{ flex: 1 }} />
            {(role !== "manager") && <CustomTabs sx={{ width: "auto !important" }} tabData={topMenu} index={menuIndex}/>}
            <Box sx={{ flex: 1 }} />
            <Box sx={{ display: { xs: 'none', md: 'flex' }, alignItems: "center" }}>
              <Fab size="small" aria-label="add" sx={{ margin: 1, backgroundColor: "#303D46" }}>
                <SearchIcon sx={{ color: "#738089" }} />
              </Fab>
              {!authentification && <Fab size={"small"} onClick={handleModal} variant="extended" sx={{ padding: 2, backgroundColor: "#303D46", "&,& *": { color: "#738089" } }}>
                Sign In
                <LoginIcon sx={{ ml: 1 }} />
              </Fab>}
              {(authentification && role !== "common") && <Avatar
                size="large"
                edge="end"
              ...
              <Fab size="small" aria-label="setting" sx={{ margin: 1, backgroundColor: "#303D46" }}>
                <TuneIcon sx={{ color: "#738089" }} onClick={handleMenuSetting} />
                <Menu
                  sx={{ mt: '45px' }}
