    ...
    return (
        <Main open={open}>
            ...
            <div className="d-flex user-page-container">
                        ...
                        <div className="main-head-intro d-flex j-between align-center">
                            <div className="main-head--logo d-flex align-center j-start">
                                ...
                                <div className="main-head--info d-flex flex-column">
                                    ...
                                    <h5 className="main-head--country text-secondary">{teamInfo.subtext}</h5>
                                </div>
                            </div>
                ...
                {teamInfo.type == "team" && <div className="main-body team-chart-lists">
                    <List subheader="Winning Percentage" sx={{ backgroundColor: "#041421", borderRadius: "8px", margin: "20px 0" }}>
                        <CustomGauge value={75} />
                    </List>
                    <List subheader="Match History" sx={{ backgroundColor: "#041421", borderRadius: "8px", margin: "20px 0" }}>
                        <CustomBarChart value={75} />
                    </List>
                    <List subheader="Team Performance" sx={{ backgroundColor: "#041421", borderRadius: "8px", margin: "20px 0" }}>
                        <CustomMultiGauge />
                    </List>
                </div>}
