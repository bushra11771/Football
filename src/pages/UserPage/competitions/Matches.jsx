...
function Matches() {
    const roundItems = [{ title: "ROUND 28", menuItems: [1, 2, 3] }, { title: "ROUND 27", menuItems: [1, 2] }];
    return (
        <>
            {
                roundItems.map((item, index) =>
                    <div key={index}>
                        ...
                        <div className="main-body competition-items">
                            ...
                            {item.menuItems.map((item, index) => <div key={index} className="d-flex match-item align-center">
