...
export const columns = [
            ...
            return (
                <div className='d-flex flex-column'>
                    <div className='d-flex align-center' style={{height:"40px"}}>
                        <img src={params.row.icon1} style={{ margin: "10px 3px", width: "25px", height: "25px" }} />
                        <span>
                            {params.row.team1}
                        </span>
                    </div>
                    <div className='d-flex align-center' style={{height:"40px"}}>
                        <img src={params.row.icon2} style={{ margin: "10px 3px", width: "25px", height: "25px" }} />
                        <span>
                            {params.row.team2}
                        </span>
                    </div>
    ...
    },
    {
        ...
        renderCell: (params) => {
            return (
                <font color="var(--main-color)">{params.value}</font>
            )
        }
    }
];